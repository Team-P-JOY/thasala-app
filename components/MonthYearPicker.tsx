...
const MonthYearPicker: React.FC<MonthYearPickerProps> = ({
  ...
  const handleMonthSelect = (monthName: string) => {
    ...
    const matchingItem = options.find(m => 
      m.label.includes(monthName) && 
      m.label.includes(currentSelection.year)
    );
  ...
  const handleYearSelect = (year: string) => {
    ...
    const matchingItem = options.find(m => 
      m.label.includes(year) && 
      m.label.includes(currentSelection.month)
    );
  ...
  return (
    ...
    >
      <View style={styles.modalHeader}>
        <CustomText bold style={styles.modalTitle}>เลือกเดือน</CustomText>
          ...
          <ScrollView style={styles.pickerScrollView} showsVerticalScrollIndicator={false}>
            {months.map((monthName, idx) => (
              <TouchableOpacity
                ...
                style={[
                  styles.pickerItem,
                  currentSelection.month === monthName ? styles.selectedPickerItem : null
                ]}
              ...
              >
                <CustomText 
                  style={[
                    ...
                    currentSelection.month === monthName ? styles.selectedPickerItemText : null
                  ]}
          ...
          <ScrollView style={styles.pickerScrollView} showsVerticalScrollIndicator={false}>
            {years.map((year, idx) => (
              <TouchableOpacity
                ...
                style={[
                  styles.pickerItem,
                  currentSelection.year === year ? styles.selectedPickerItem : null
                ]}
              ...
              >
                <CustomText 
                  style={[
                    styles.pickerItemText,
                    currentSelection.year === year ? styles.selectedPickerItemText : null
                  ]}
